...
- **Mecanismo do Cotali:** o app baixa o PDF autenticado do backend e usa o compartilhamento nativo. No Android, o adaptador direciona para o WhatsApp e usa o telefone normalizado do cliente; no iOS, o PDF e a mensagem são entregues à folha nativa para o usuário escolher o WhatsApp.
...
- **O que acontece depois da ação:** o Cotali gera/baixa o PDF, prepara a mensagem e inicia o compartilhamento. Android abre o WhatsApp para o número válido; iOS abre a folha nativa com PDF e mensagem; o usuário ainda confirma o destinatário e o envio.
...
- **Estados de erro, espera e recuperação:** botão mostra carregamento; erros informam a causa sem afirmar que houve entrega; o botão **Exportar PDF** permite compartilhar ou salvar manualmente o arquivo.
...
- [x] Dados ausentes continuam ausentes; telefone ausente bloqueia o direcionamento.
...
- **Meta ou critério de decisão:** o Android deve abrir o WhatsApp com PDF e mensagem no número de teste; o iOS deve mostrar PDF e mensagem na folha nativa; falhas devem levar ao fallback sem perda do arquivo.
...
- **Decisão tomada:** usar `react-native-share` para a ação principal, com direcionamento no Android e fallback nativo no iOS; manter `expo-sharing` para exportação genérica.
